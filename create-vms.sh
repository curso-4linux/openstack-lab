...
gcloud compute instances create openstack-vm-temp --image-family=projects/ubuntu-os-cloud/global/images/family/ubuntu-2004-lts --zone=us-central1-b --boot-disk-size=50GB

### 02 - Para a instância openstack-vm-temp
gcloud compute instances stop openstack-vm-temp  --zone=us-central1-b
...
gcloud compute addresses create openstack-controller openstack-compute1 openstack-compute2 --region=us-central1
...
gcloud compute disks create openstack-block-storage-disk2 openstack-block-storage-disk3 \
 ...
 --type=pd-balanced --size=80GB --zone=us-central1-b
